...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    fileImage: function fileImage() {
      var file = this.$refs.file_image.files[0]; // Reset previous error message

      this.mainImageerror = null; // Check if a file was selected
    ...
    otherImage: function otherImage() {
      ...
      for (var i = 0; i < files.length; i++) {
        var file = files[i]; // Check if the file is an image (you can extend the list of allowed file types)
    ...
    variantImagesChanges: function variantImagesChanges(index) {
      ...
      if (this.type === 'packet') {
        ...
        for (var i = 0; i < this.$refs['packet_variant_images_' + index][0].files.length; i++) {
          ...
          var extension = file.name.split('.').pop().toLowerCase(); // Check if the file extension is valid
    ...
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/edit/' + this.id).then(function (response) {
        ...
        if (data.status === 1) {
          ...
          _this10.fssai_lic_no = _this10.record.fssai_lic_no;
          var vm = _this10;
                                ...
                                _c("div", { staticClass: "col-md-12 " }, [
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _vm.variantImageerror
                                      ? _c("p", { staticClass: "error" }, [
                                          _vm._v(_vm._s(_vm.variantImageerror)),
                                        ])
                                      : _vm._e(),
                                    _vm._v(" "),
                                    _c(

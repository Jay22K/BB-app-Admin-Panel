            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>B2B Pending Customers</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link to="/dashboard">{{ __('dashboard') }}</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page">B2B Pending Customers List</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<!--                            {{ customers }}-->
                        <b-table
                            ...
                            <template #cell(actions)="row">
                               ...
                               <button  class="btn btn-sm btn-success offset-2" @click="showB2bModalMethod(row.item)">
                                    <i class="fa fa-eye"></i>
                                </button>
<!--                                <div class="form-check form-switch">
        ...
        <b-modal v-model="b2bCustomerInfoPopupState" size="xl" title="B2b Customer Info">
  ...
  components: {
    ...
    methods: {
        ...
        getCustomers(){
            let vm = this;
            this.isLoading = true;
            axios.get(this.$apiUrl + '/b2b-users')
                .then((response) => {
